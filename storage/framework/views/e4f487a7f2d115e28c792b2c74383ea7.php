    ...
    <div class="auth-card">
        ...
        <form method="POST" action="/register">
            ...
            <div class="auth-field">
                <label>Name</label>
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Your name" required autofocus>
            </div>
            <div class="auth-field">
                <label>Email</label>
...
<?php /**PATH C:\repos\courtly\resources\views\auth\register.blade.php ENDPATH**/ ?>