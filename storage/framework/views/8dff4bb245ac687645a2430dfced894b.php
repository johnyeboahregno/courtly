...
<head>
    ...
    <title>Courtly — <?php echo e($sessionName); ?></title>
    ...
    <link rel="stylesheet" href="/css/courtly.css?v=4">
</head>
<body>
...
<script>
const SESSION_ID = <?php echo e($sessionId); ?>;
const START_STATUS = "<?php echo e($sessionStatus); ?>";
const START_NAME = "<?php echo e($sessionName); ?>";

const { createApp, ref, reactive, computed, onMounted, onUnmounted, TransitionGroup } = Vue;
...
<?php /**PATH C:\repos\courtly\resources\views\session-live.blade.php ENDPATH**/ ?>