...
<div class="auth-page">
    <div class="auth-card">
        ...
        <?php if($errors->any()): ?>
            <div class="auth-error"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
        ...
        <form method="POST" action="/login">
            ...
            <div class="auth-field">
                <label>Email</label>
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="you@example.com" required autofocus>
            </div>
            <div class="auth-field">
        ...
        <a href="/auth/google/redirect" class="social-btn social-btn--google">
        ...
        <a href="/auth/facebook/redirect" class="social-btn social-btn--facebook">
...
<?php /**PATH C:\repos\courtly\resources\views\auth\login.blade.php ENDPATH**/ ?>