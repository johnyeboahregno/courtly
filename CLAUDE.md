...
Courtly is installable as a PWA — the web app stays exactly as-is, and mobile users can "Add to Home Screen" (Android/iOS) for a standalone, full-screen launch. No offline caching by design.
